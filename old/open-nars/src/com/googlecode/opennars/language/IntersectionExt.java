...
public class IntersectionExt extends CompoundTerm {
     ...
     */
    public IntersectionExt(String n, ArrayList<Term> arg) {
        super(n, arg);
    }
     ...
     * @param n The name of the term
     */
    public IntersectionExt(String n, ArrayList<Term> cs, ArrayList<Variable> open, ArrayList<Variable> closed, short i) {
