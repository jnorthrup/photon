...
public class DifferenceInt extends CompoundTerm {
     ...
     */
    public DifferenceInt(String n, ArrayList<Term> arg) {
        super(n, arg);
    }
     ...
     * @param n The name of the term
     */
    public DifferenceInt(String n, ArrayList<Term> cs, ArrayList<Variable> open, ArrayList<Variable> closed, short i) {
