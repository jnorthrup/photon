 ...
 */
public class TruthValueRefier implements Cloneable, TruthValue { // implements Cloneable {
     ...
     */
    public TruthValueRefier(float f, float c) {
     ...
     *
     */
    public TruthValueRefier(float f, float c, boolean b) {
        frequency = new ShortFloat(f);
        confidence = (c < 1) ? new ShortFloat(c) : new ShortFloat(0.9999f);
        isAnalytic = b;
    }
     ...
     */
    public TruthValueRefier(TruthValue v) {
    ...
    public boolean equals(Object that) {
        return ((that instanceof TruthValueRefier)
    ...
    @Override
    public Object clone() {
        return new TruthValueRefier(getFrequency(), getConfidence(), getAnalytic());
    }
