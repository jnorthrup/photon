 ...
 */
public class TaskLinkHandle extends TermLinkHandle implements TaskLink {

    /**
     * The Task linked. The "target" field in TermLink is not used here.
     */
    public TaskHandle targetTask;
    /**
     ...
     * @param v The budget
     */
    public TaskLinkHandle(TaskHandle t, TermLink template, BudgetValueAtomic v) {
        super("", v);
        targetTask = t;
        if (template == null) {
            type = TermLinkHandle.SELF;
            index = null;
        } else {
     ...
     */
    @Override
    public TaskHandle getTargetTask() {
        return targetTask;
    }
