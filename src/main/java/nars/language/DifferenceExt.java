...
public class DifferenceExt extends CompoundTerm {
     ...
     */
    private DifferenceExt( List<Term> arg) {
        super(arg);
    }
     ...
     */
    private DifferenceExt(String n ,  List<Term> cs, boolean con, short i) {
        super(n, cs, con, i);
    }
    ...
    public static Term make( List<Term> argList, Memory memory) {
        ...
        var name = makeCompoundName(Symbols.DIFFERENCE_EXT_OPERATOR, argList);
    ...
    @Override
    public Object clone() {
        return new DifferenceExt(name, ( List<Term>) cloneList(components), isConstant(), complexity);
    }
