 ...
 */
public class BudgetValueAtomic implements BudgetValue {
     ...
     */
    public BudgetValueAtomic(float p, float d, float q) {
     ...
     */
    public BudgetValueAtomic(BudgetValueAtomic v) {
    ...
    @Override
    public Object clone() {
        return new BudgetValueAtomic(this.getPriority(), this.getDurability(), this.getQuality());
    }
     ...
     */
    public void merge(BudgetValueAtomic that) {
