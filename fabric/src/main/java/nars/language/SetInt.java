...
public class SetInt extends CompoundTerm {
     ...
     */
    private SetInt(String n, List<Term> cs, boolean con, int i) {
        super(n, cs, con, i);
    }
     ...
     */
    public Object clone() {
        return new SetInt(name, (ArrayList<Term>) cloneList(getComponents()), isConstant(), getComplexity());
    }
    ...
    public String makeName() {
        return makeSetName(Symbols.SET_INT_OPENER, getComponents(), Symbols.SET_INT_CLOSER);
    }
}
