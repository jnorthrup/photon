...
public class IntersectionInt extends CompoundTerm {
     ...
     */
    private IntersectionInt(String n, List<Term> cs, boolean con, int i) {
        super(n, cs, con, i);
    }
    ...
    @NotNull
    private static Object doCLone(IntersectionInt intersectionInt) {
        return new IntersectionInt(intersectionInt.name, (ArrayList<Term>) cloneList(intersectionInt.getComponents()), intersectionInt.isConstant(), intersectionInt.getComplexity());
    }
