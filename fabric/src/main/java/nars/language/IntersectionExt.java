...
public class IntersectionExt extends CompoundTerm {
     ...
     */
    private IntersectionExt(List<Term> arg) {
        super(arg);
    }
     ...
     */
    private IntersectionExt(String n, List<Term> cs, boolean con, int i) {
        super(n, cs, con, i);
    }
    ...
    @NotNull
    private static IntersectionExt doCLone(IntersectionExt intersectionExt) {
        return new IntersectionExt(intersectionExt.name, (List<Term>) cloneList(intersectionExt.getComponents()), intersectionExt.isConstant(), intersectionExt.getComplexity());
    }
