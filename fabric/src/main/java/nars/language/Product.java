...
public class Product extends CompoundTerm {
     ...
     */
    private Product(String n, List<Term> cs, boolean con, int complexity) {
     ...
     */
    public Object clone() {
        return new Product(name, (ArrayList<Term>) cloneList(getComponents()), isConstant(), getComplexity());
    }
    ...
    public static Term make(CompoundTerm image, Term component, int index, Memory memory) {
        List<Term> argument = image.cloneComponents();
